...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: EnvelopeIcon,
      title: 'Email',
      details: ['hello@postifystudio.com', 'support@postifystudio.com']
    },
    {
      icon: ClockIcon,
            ...
            <div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="bg-gray-800 text-white p-3 rounded-full hover:bg-gray-900 transition duration-300">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Drop by our office for a coffee and let's discuss your project in person.
            </p>
          </div>
